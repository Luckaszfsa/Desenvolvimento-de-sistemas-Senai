#4) Faça um programa de implemente um jogo de Dados. O jogador lança um par de dados, obtendo um valor entre 2 e 12. Se, na primeira jogada, você tirar
# 7 ou 11, você ganhou. Se você tirar 2, 3 ou 12 na primeira jogada, você perdeu.
