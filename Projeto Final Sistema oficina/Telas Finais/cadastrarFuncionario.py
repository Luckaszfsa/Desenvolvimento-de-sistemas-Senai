...
class ver_cadastrar_func():
    def __init__(self):
        ...
        self.janelaCad_Func.title('Automativo Soluções')
...
# ============= SEÇÕES ================ #
        ...
        self.wrapper1 = LabelFrame(
            self.container1, text='Funcionários',bg="#484848",fg="#e1e3db")
        self.wrapper2 = LabelFrame(
            self.janelaCad_Func, text='Procurar',bg="#484848",fg="#e1e3db")
        self.wrapper3 = LabelFrame(
            self.container1, text='Dados do Funcionário',bg="#484848",fg="#e1e3db")
        self.rodape = Frame(self.janelaCad_Func, bg="#484848")

        self.container1.pack(fill='both', expand='no', padx=20, pady=10)
        self.wrapper1.pack(fill='both', expand='no',
                           padx=20, pady=10, side="left")
...
# ------------- BOTÕES ------------- #
        ...
        self.mostrarBtn.pack(side='right', padx=500, pady=10)
...
# ============= FUNÇÕES ============== #
    ...
    def voltar_tela(self):
        ...
        # from telaMenuMec import Tela_da_Oficina
        # return Tela_da_Oficina()
