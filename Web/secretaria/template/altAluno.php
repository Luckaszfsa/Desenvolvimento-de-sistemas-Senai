                ...
                <form class="row g-3" method="post" action="index.php?r=alterarAluno&id=<?php echo $id; ?>">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="sexo">
                            <option value="<?php echo $dados['estado_civil']; ?>"><?php echo $dados['estado_civil']; ?>
                            </option>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="cpf" value="<?php echo $dados['cpf']; ?>" id="cpf" class="form-control"
                            id="inputEmail4" onblur="return verificarCPF(this.value)">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="rua" value="<?php echo $dados['rua']; ?>" id="rua" readonly
                            class="form-control">
                    </div>

                    <div class="col-md-6">
                        <label for="inputPassword4" class="form-label">Cidade</label>
                        <input type="text" name="cidade" value="<?php echo $dados['cidade']; ?>" id="cidade" readonly
                            class="form-control">
                    </div>

                    <div class="col-md-6">
                        <label for="inputPassword4" class="form-label">Bairro</label>
                        <input type="text" value="<?php echo $dados['bairro']; ?>" name="bairro" readonly
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="estado" readonly class="form-control"
                            value="<?php echo $dados['estado']; ?>" id="uf">
                    </div>

                    <div class="col-md-12">
                        <label for="inputPassword4" class="form-label">Observação</label>
                        <textarea name="obs" rows="7" cols="10"
